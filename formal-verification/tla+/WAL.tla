...
(*                                                                          *)
(* ABSTRACTION NOTE: This module models WAL operations at the LOGICAL level,*)
(* assuming atomic file operations. For filesystem-level verification       *)
(* including TOCTOU race handling, see WAL_FileSystem.tla which refines     *)
(* this specification using FileSystem.tla.                                 *)
(*                                                                          *)
(* Key properties verified at THIS level:                                   *)
...
(*                                                                          *)
(* Additional properties verified at FILESYSTEM level (WAL_FileSystem.tla): *)
(* 5. TOCTOU Safety: exists() + open() race handled correctly               *)
(* 6. Parent Directory: mkdir_all() ensures parent exists before create     *)
(*                                                                          *)
(* ABSTRACTION GAP DOCUMENTED (see VERIFICATION_RESULTS.md):                *)
(* This module abstracts file operations as single atomic transitions:      *)
(*   - WalCreate == files' = files + {walPath}  (one step)                  *)
(*   - WalOpen == openHandle' = files[walPath]  (one step)                  *)
(*                                                                          *)
(* In reality, these involve multiple syscalls:                             *)
(*   - WalCreate: stat() -> mkdir_all() -> open(O_CREAT)                    *)
(*   - WalOpen: exists() -> open()                                          *)
(*                                                                          *)
(* Between any two syscalls, another process can:                           *)
(*   - Delete the parent directory                                          *)
(*   - Delete the WAL file                                                  *)
(*   - Create a conflicting file                                            *)
(*                                                                          *)
(* The WAL_FileSystem.tla refinement addresses these gaps.                  *)
(****************************************************************************)
