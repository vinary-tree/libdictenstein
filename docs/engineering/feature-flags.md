...
| `protobuf` | | Protobuf (de)serialization | `prost`, `prost-build` | richest parse surface; recursion + preallocation edges documented in [deserialization-safety](../security/deserialization-safety.md) |
