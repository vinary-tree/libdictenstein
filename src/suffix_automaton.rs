...
// `crate::suffix_automaton_core::SuffixAutomatonInner<u8, V>` (which
...
mod _legacy_extend_byte {
    ...
    // generic `crate::suffix_automaton_core::SuffixAutomatonInner<U, V>`.
    //
    // fn new() -> Self {
    //     Self {
...
// `crate::suffix_automaton_core::SuffixAutomatonInner::extend(unit: U)`
