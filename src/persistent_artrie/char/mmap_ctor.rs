...
impl<V: DictionaryValue> super::PersistentARTrieChar<V> {
    ...
    pub fn create<P: AsRef<Path>>(path: P) -> Result<Self> {
        ...
        // S5-12 EDIT 1: install the overlay for a fresh trie of every value type.
...
mod s5_12_flip_ctor_gate {
        ...
        // Membership (V = ()).
        {
            ...
            let terms: Vec<String> = (0..40u32).map(|i| format!("term{i:03}")).collect();
            {
                ...
                trie.set_durability_policy(
                    crate::persistent_artrie::core::durability::DurabilityPolicy::Immediate,
                );
    ...
    fn s5_12_old_binary_fail_closed_on_overlay_magic() {
        ...
        assert_eq!(
            h.regime(),
            crate::persistent_artrie::core::wal::RankRegime::Overlay,
