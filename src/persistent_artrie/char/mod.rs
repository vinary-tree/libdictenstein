    ...
    for Arc<PersistentARTrieChar<V, S>>
{
    ...
    fn read(
        &self,
    ) -> crate::persistent_artrie::core::shared_access::TrieAccessGuard<
        '_,
...
/// generic [`OverlayDictionaryNode<CharKey, V>`](crate::persistent_artrie::core::overlay::OverlayDictionaryNode)
/// in `persistent_artrie::core`. The byte and char overlay-backed `DictionaryNode`
...
pub type PersistentARTrieCharNode<V = ()> =
    crate::persistent_artrie::core::overlay::OverlayDictionaryNode<CharKey, V>;
...
impl<V: DictionaryValue + Clone> MutableMappedDictionary for SharedCharARTrie<V> {
        ...
        Self::Value: Clone,
    {
        ...
        // snapshot-then-release pattern (persistent_artrie/vocab/mod.rs:476).
    ...
    > for PersistentARTrieChar<V, S>
{
    ...
    fn overlay_root_slot(
        ...
        &crate::persistent_artrie::core::overlay::AtomicNodePtr<
            crate::persistent_artrie::core::key_encoding::CharKey,
            V,
        >,
    > {
