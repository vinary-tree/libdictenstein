...
use crate::persistent_artrie::core::buffer_manager::BufferManager;
use crate::persistent_artrie::core::disk_manager::{MmapDiskManager, BLOCK_SIZE};
...
struct CachedPage {
    frame_id: crate::persistent_artrie::core::buffer_manager::FrameId,
