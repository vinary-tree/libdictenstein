...
use crate::persistent_artrie::core::overlay::evict::{
    ...
    OverlayEvictable<K, V, S> + Sized + 'static
{
    ...
    fn lockfree_root(
        &self,
    ) -> Option<&crate::persistent_artrie::core::overlay::AtomicNodePtr<K, V>>;
    ...
    fn publish_root_cas_ranked(
        ...
        loop {
            ...
            // A writer that overtakes this snapshot makes the CAS fail; the retry
            // discards this claim before loading and claiming again.
        ...
        K: crate::persistent_artrie::core::eviction::RegistryFamily,
    {
        ...
        let winners = crate::persistent_artrie::core::recovery::reconcile_lww_with_regime(
            all_records,
            loaded_from_disk,
    ...
    fn reconcile_and_drain_overlay(
        &self,
        config: &crate::persistent_artrie::core::wal::WalConfig,
        loaded_from_disk: bool,
        image_checkpoint_lsn: crate::persistent_artrie::core::wal::Lsn,
    ) -> Result<usize>
    where
