(defproject io.vinarytree/libdictenstein-clojure "4.0.0-rc.2"
  ...
  :dependencies [[org.clojure/clojure "1.12.5" :scope "provided"]
                 [io.vinarytree/vinary-tree-interop "4.0.0-rc.2"]
                 [io.vinarytree/libdictenstein "4.0.0-rc.2"]]
  :profiles {:test {:dependencies [[org.clojure/data.json "2.5.2"]
                                   [io.vinarytree/liblevenshtein "4.0.0-rc.2"]]}}
  :source-paths ["src"]
  :test-paths ["test"]
